...
if 'config' not in st.session_state:
    st.session_state.config = {
        ...
        # --- TAMBAHAN UNTUK V69 (CUSTOM OPTIONS) ---
...
# =============================================================================
# 🚦 V69 GATEKEEPER LOGIC: DIGITAL HEALTH CARD (CLEAN TIMELINE UI)
# =============================================================================
        ...
        if not history.empty:
            ...
            if len(history) > 1:
                ...
                for _, row in prev_jobs.iterrows():
                    # V69 CHANGE: Clickable Expander for History (CLEAN UI - No Status)
                    with st.expander(f"📅 {row['Tarikh']} - {row['Masalah']}"):
                        # Status disorokkan melainkan kalau user nak sangat tengok, boleh letak dalam ni
